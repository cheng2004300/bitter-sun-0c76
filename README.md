...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/bitter-sun-0c76#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/bitter-sun-0c76
```

A live public deployment of this template is available at [https://bitter-sun-0c76.templates.workers.dev](https://bitter-sun-0c76.templates.workers.dev)
